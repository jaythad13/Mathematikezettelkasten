...
\begin{problem}[9.]
	Let $\Omega$ be abounded open subset $\mathbb{C}$, and $\varphi : \Omega \to \Omega$ be a holomorphic function. Prove that if there exists a point $z_{0} \in \Omega$ such that
	\[
