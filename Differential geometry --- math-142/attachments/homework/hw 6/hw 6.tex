...
\begin{solution}
	\[
		\boxed{
			\nabla_{\mathbf{V}}(r \cos{\vartheta} \, \mathbf{E}_{1} + r \sin{\vartheta} \, \mathbf{E}_{2}) = \left ( v_{1} - y \frac{-y v_{1} + x v_{2}}{r^{2}} \right ) \mathbf{E}_{1} + \left ( v_{2} + x \frac{-y v_{1} + x v_{2}}{r^{2}} \right ) \mathbf{E}_{2}.
		}
	\]
	...
	\[
		\begin{split}
			\nabla_{\mathbf{V}}(r \cos{\vartheta} \, \mathbf{E}_{1} + r \sin{\vartheta} \, \mathbf{E}_{2}) & = \nabla_{\mathbf{V}}(x \, \mathbf{E}_{1} + y \, \mathbf{E}_{2}) \\
														       ...
														       & = (v_{1} - y \, d\vartheta(\mathbf{V})) \mathbf{E}_{1} + (v_{2} + x \, d\vartheta(\mathbf{V})) \mathbf{E}_{2} \\
														       & = \left ( v_{1} - y \frac{-y v_{1} + x v_{2}}{r^{2}} \right ) \mathbf{E}_{1} + \left ( v_{2} + x \frac{-y v_{1} + x v_{2}}{r^{2}} \right ) \mathbf{E}_{2}.
		\end{split}
	\]
\end{solution}
