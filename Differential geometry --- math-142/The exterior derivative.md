...
Finally, it preserves the really important property $d^2 = 0$ [[Differential forms#Motivating questions|that we've been hinting at]] — $\phi = df$ for some smooth function $f$, if and only if $d\phi = 0$ (here $\phi$ is a $1$-form).
