...
The [[The framework of differential geometry#_definition _ tangent space at $ mathbf{p}$, $ mathrm{T}_{ mathbf{p}} mathbb{R} 3$ , tangent vectors|correspondence between tangent vectors and lines]] that we noticed last time allows us to think about directional derivatives as tangent vectors too! 
