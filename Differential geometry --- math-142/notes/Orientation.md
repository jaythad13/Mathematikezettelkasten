...
Since the [[Proper Euclidean motions#_proposition _ the tangent maps of isometries behave like isometries|tangent map is basically just the orthogonal part]], this leads us naturally to defining the sign of a proper Euclidean motion.
