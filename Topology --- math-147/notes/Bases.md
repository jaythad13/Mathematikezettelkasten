...
This is a really interesting topology for reasons of separation properties. In particular, if we [[Analysis --- math-131/notes/Metric subspaces|use the idea of subspace topologies]] from real analysis, we'd see that $\mathbb{R} \times \{ 0 \}$ is given the [[Topology --- math-147/notes/Topologies#_example _ the discrete and indiscrete topologies|discrete topology]]. (Does this carry over to topological spaces in general? We'll find out soon).
