...
In the case where $X = \mathbb{C}$ or $\mathbb{R}$, these are the [[Algebraic Geometry --- math-176/notes/The Zariski topology|Zariski topology]], or the analogue generated by [[Complex Analysis --- math-135/notes/Power series|analytic functions]]. 
