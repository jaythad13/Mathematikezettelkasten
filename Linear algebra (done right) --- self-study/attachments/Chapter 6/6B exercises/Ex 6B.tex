...
\begin{solution}
	Let $v_1, \dots, v_n$ be a basis of $V$. Let $e_1, \dots, e_n$ be the orthonormal basis obtained by applying the Gram-Schmidt procedure with respect to the first inner product. Let  $f_1, \dots, f_n$ be the orthonormal basis obtained by applying the Gram-Schmidt procedure with respect to the second inner product. \\\\
	For any $v \in V$ we can write $v = a_{1} v_{1} + \dots + a_{n} v_{n}$, or $v = a_{1} \lVert v_{1} \rVert e_{1} + \dots + a_{n} v_{n}$. Then
\end{solution}
