...
\begin{solution}
	Let $v_1, \dots, v_n$ be a basis of $V$. Let $e_1, \dots, e_n$ be the orthonormal basis obtainted by the Gram-Schmidt procedure, with respect to the first inner product. Let  $f_1, \dots, f_n$ be the orthonormal basis obtained by the Gram-Schmidt procedure with respect to the second inner product. \\\\
\end{solution}
