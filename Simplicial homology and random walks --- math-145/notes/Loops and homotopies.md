...
A loop in a region $D \subseteq \mathbb{R}^{2}$ is a [[Analysis --- math-131/notes/Continuity#_definition _ continuity|continuous]] function $f : [0, 1] \to D$ such that $f(0) = f(1)$.
