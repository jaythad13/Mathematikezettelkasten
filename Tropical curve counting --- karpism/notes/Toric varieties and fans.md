...
1) The fan $\Sigma \subseteq \mathbb{R}^{2}$ containing all $2$-cones $\left< (\pm 1, 0), (0, \pm 1) \right>$ is complete, containing all of $\mathbb{R}^{2}$. It corresponds to $X_{\Sigma} = \mathbb{P}^{1} \times \mathbb{P}^1$.
2) Any of the fans $\Sigma \subseteq \mathbb{R}^{2}$ containing any two of the cones above corresponds to $X_{\Sigma} = \mathbb{P}^1 \times \mathbb{P}^1 \setminus \{ p_{1}, p_{2} \}$ where $p_{1}, p_{2}$ are two $\mathbb{T}$-invariant fixed points.
3) The fan $\Sigma \subseteq \mathbb{R}^{2}$ containing the two $1$-cones $\left< (1, 0) \right>$ and $\left< (0, 1) \right>$ corresponds to $X_{\Sigma} = \mathbb{A}^{2} \setminus \{ (0, 0)  \}$.
4) The fan $\Sigma \subseteq \mathbb{R}^{2}$ containing the three $2$-cones $\left< (1, 0), (0, 1) \right>$, $\left< (0, 1), (-1, 1) \right>$, and $\left< (-1, -1), (0, 1) \right>$ corresponds to $X_{\Sigma} = \mathbb{P}^{2}$. In fact this can be generalised. Suppose $v_{0}, v_{1}, \dots, v_{n}$ generate a rank $n$ lattice $M$ and $v_{0} + v_{1} + \dots + v_{n} = 0$. If $\Sigma \subseteq \mathbb{R}^n$ consists of all the cones generated by $n$-subsets of the $n +1$ vectors, then $X_{\Sigma} = \mathbb{P}^n$.
