...
\begin{solution}
	Since $P$ is projective, we can find some $R$-module $N$ such that $P \oplus N \cong F$ is free. Further, since $P$ is finitely generated, we can choose $F$ to be a finitely generated. We choose $F = R^{\oplus n}$ to be the finitely generated free module surjecting onto $P$ and note that by the projectivity of $P$, the exact sequence
	\[
		\begin{tikzcd}
			0 \ar[r] & \ker \varphi \ar[r] & F \ar[r, "\varphi"] & P \ar[r] & 0
		\end{tikzcd}
	\]
	splits. Thus, $P \oplus N \cong F$ with $N = \ker \varphi$ and $F = R^{\oplus n}$.

	Since direct sums in the first slot of $\operatorname{Hom}$ turn into direct products and finite direct products are direct sums, we have the following identity.
	\[
	...
	\]
	 We claim that since $F$ is finitely generated, $\operatorname{Hom}_{R}(F, R)$ is free. Then, since we have written $\operatorname{Hom}_{R}(P, R)$ as a direct summand of a free module, we have shown that it is projective.
	...
	\begin{align*}
		\operatorname{Hom}_{R}(F, R) & \cong \operatorname{Hom}_{R}(R^{\oplus n}, R) \\
					     ...
					     & = R^{\oplus n}.
	\end{align*}
	The last equality follows because $\operatorname{Hom}_{R}(R, M) \cong M$. Note that we needed finite generation for $\operatorname{Hom}$ to commute with direct sums in the first slot. If $F$ was not finitely generated then we would get a direct product instead of a direct sum.
\end{solution}
