...
$$
V = \{ f : \mathbb{Z} / n \mathbb{Z} \to \mathbb{C} \}
$$
...
##### _proposition:_ an orthonormal basis on $V$
...
##### _proposition:_ Fourier coefficients recover the function

For any $f : \mathbb{Z} / n \mathbb{Z} \to \mathbb{C}$ we have $f = \sum_{\ell \in \mathbb{Z} / n \mathbb{Z}} \hat{f}(\ell) e_{\ell}$.
...
##### _proposition:_ discrete Plancherel's theorem

For any $f : \mathbb{Z} / n \mathbb{Z} \to \mathbb{C}$ we have
$$
\lVert f \rVert^{2} = \sum_{\ell \in \mathbb{Z} / n \mathbb{Z}} \lvert \left< f, e_{\ell} \right>  \rvert^{2}
$$
...
$$
\hat{f}(k) = \frac{\hat{g}_{0}(k) + \hat{g}_{1}(k) \omega^k}{2}
$$
where $\omega = e^{2 \pi i / 2n}$ is the first $2n$th root of unity.
