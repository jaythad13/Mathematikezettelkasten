...
1) A vector space is an abelian group $V$ acted on by its base field $\mathbb{F}^\times$, with the additional requirement that the group action distributes over the operation on the abelian group and $0v = 0$.
