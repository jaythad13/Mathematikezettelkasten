...
\begin{solution}
	\begin{enumerate}
		...
		\item \fbox{False} \\\\
			We have shown in class that the group of rotational symmetries of the regular tetrahedron has order $12$, but no subgroup of order $6$, even though $6 \mid 12$.
		\item \fbox{False} \\\\
			We have shown in class (in the lemma prior to our proof of the second isomorphism theorem) that $HK$ is a subgroup of $G$ if and only if $HK = KH$. 
	\end{enumerate}
\end{solution}
