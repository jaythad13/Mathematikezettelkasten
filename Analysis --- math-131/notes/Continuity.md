...
A function is continuous if it is its [[Analysis --- math-131/notes/Limits#_definition _ limit|limit]].
...
This follows from [[Analysis --- math-131/notes/Limits#_proposition _ limits of functions are limits of functions on sequences|the corresponding result for limits]].
...
##### _theorem:_ continuity preserves [[Analysis --- math-131/notes/Compactness#_definition _ compact|compactness]]
...
##### _theorem:_ continuity preserves [[Analysis --- math-131/notes/Connectedness#_definition _ connectedness|connectedness]]
...
Again, this follows from [[Analysis --- math-131/notes/Limits#_proposition _ limits of operations on the complex numbers|the corresponding result for limits]].
