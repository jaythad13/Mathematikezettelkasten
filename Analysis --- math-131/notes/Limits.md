...
This follows from [[Analysis --- math-131/notes/Sequences and convergence#_proposition _ the convergence of operations on the complex numbers|the corresponding result for sequences]].
