...
If $a_{n} \ge 0$, then $\{ s_{n} \}_{n}$ is monotonically increasing, and [[Analysis --- math-131/notes/Sequences and convergence#_proposition _ monotonic sequences blow up or converge|thus]], must be bounded in order to converge.
...
\end{split}
$$
Here, the last equality follows since the [[Analysis --- math-131/notes/Sequences and convergence#_proposition _ sequences of powers and roots|the limit vanishes]].
