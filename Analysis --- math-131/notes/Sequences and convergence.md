...
The sequence $\{ 1/n \}_{n}$ converges in $\mathbb{R}$ to $0$ by the [[Analysis --- math-131/attachments/homework/hw 1/hw 1.pdf#page=4|Archimedean property]].
...
If $x$ is a [[Analysis --- math-131/notes/Metric spaces#_definition _ limit point|limit point]] of $E \subset X$, then there is a sequence $\{ x_{n} \}_{n}$ in $E$ converging to $x$.
