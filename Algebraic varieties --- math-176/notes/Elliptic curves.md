...
3) $E$ is a [[Algebraic varieties --- math-176/notes/Non-singular projective varieties#_definition _ non-singular projective variety|non-singular projective variety]] of dimension $1$ if and only if $\Delta(E) = -16(4A^3 + 27 B^{2}) \neq 0$.
...
Recall that [[Algebraic varieties --- math-176/notes/Elliptic integrals#Computing irrational integrals of quartics and cubics|we can rewrite the quartic]]
$$
y^{2} = (1 - x^{2})(1 - k^{2} x^{2})
$$
