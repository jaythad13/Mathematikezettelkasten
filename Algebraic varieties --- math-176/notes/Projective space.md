...
The idea of projective space is to consider numbers in a field only upto ratio, [[Algebraic varieties --- math-176/notes/Pythagorean triples and conic sections#_proposition _ the character of a Pythagorean triple|just like we did with Pythagorean triples]]. For this, fix a field $F$.
...
$$
Note, one can think of $\mathbb{A}^n$ as a [[Algebraic geometry --- rising-sea/notes/Functors|functor]] that takes fields and spits out affine spaces.
...
Doesn't that formula look familiar? It's exactly the formula for parameterising [[Algebraic varieties --- math-176/notes/Pythagorean triples and conic sections#_proposition _ the character of a Pythagorean triple|Pythagorean triples and conic sections]]! This follows by exactly the same argument!
...
Our goal in this class is going to be to generalise a line $L$ inside $\mathbb{P}^2$ to a [[Algebraic varieties --- math-176/notes/Non-singular projective varieties|variety]] inside $\mathbb{P}^n$.