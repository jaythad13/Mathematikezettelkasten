...
This motivates considering the inverse of the arc length function — the [[Algebraic varieties --- math-176/notes/Elliptic functions#_definition _ Jacobi elliptic function|Jacobi elliptic function]], which Euler did, and used to greatly generalise this formula!
