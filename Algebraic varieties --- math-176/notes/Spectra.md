...
##### _example:_ the spectra of a field and its [[Algebraic varieties --- math-176/notes/Polynomial rings#_definition _ polynomial, degree, $R[x]$|polynomial ring]]
...
One reason that spectra are so useful is that we can use the max spectrum of a polynomial ring to replace [[Algebraic varieties --- math-176/notes/Projective space#_definition _ affine space|affine space]]!
...
We can use [[Algebraic varieties --- math-176/notes/Irreducible subsets#_proposition _ $V$ irreducible implies $I(V)$ prime|the correspondence between primes and irreducible varieties]] to think of prime ideals in the spectrum as points.
