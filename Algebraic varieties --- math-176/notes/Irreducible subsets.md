...
What did we mean when we said [[Algebraic varieties --- math-176/notes/Non-singular projective varieties#_definition _ non-singular projective variety|a variety has to be irreducible]]? Does this have an algebraic meaning?

##### _proposition:_ $V$ irreducible implies $I(V)$ prime

Let $F$ be a field and denote $R = F[x_{1}, \dots, x_{n}]$, and $X = \mathbb{A}^n(F)$. The following are equivalent for a [[Algebraic varieties --- math-176/notes/The Zariski topology#_definition _ the Zariski topology|Zariski closed]] $V \subseteq X$.
