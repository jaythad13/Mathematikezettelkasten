...
Note that we can do the same thing we did with [[Curves and surfaces --- math-142/notes/Vector fields#_definition _ $ mathbf{V}[f]$, derivation|derivations]] and extend the definition for tangent vectors to a definition for vector fields.
