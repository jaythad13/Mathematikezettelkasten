...
\begin{solution}~
	...
	We know that there is a rational number between any two reals. Thus, for any two $a, b \in \mathbb{R}$ with $a < b$, and a positive $x \in \mathbb{R} \setminus \mathbb{Q}$, we have some rational $r$ such that
	\[
		a/x < r < b/x.
	\]
