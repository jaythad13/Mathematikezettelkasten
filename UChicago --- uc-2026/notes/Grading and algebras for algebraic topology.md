...
##### _definition:_ exterior algebra

The **exterior algebra $A[x_{1}, \dots, x_{n}]^\text{ext}$ generated by $x_{i}$ in degree $d_{i}$** is the free graded-commutative graded $A$-algebra with such generators.
