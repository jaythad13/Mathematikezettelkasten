...
Let $G$ and $H$ be [[Abstract algebra --- math-171/notes/Groups, and why you should care#_definition _ group|groups]]. A group homomorphism $\varphi : G \to H$ is a function such that for all $x, y \in G$ we have
$$
