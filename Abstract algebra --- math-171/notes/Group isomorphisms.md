...
This is an isomorphism! We will use this notion in this class very liberally, and not just for groups.

It turns out that all we need to have this notion of two groups being the same is a bijective [[Abstract algebra --- math-171/notes/Group homomorphisms|homomorphism]].
