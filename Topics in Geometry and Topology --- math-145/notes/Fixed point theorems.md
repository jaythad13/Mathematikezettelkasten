...
The disc must be closed since otherwise you could contract towards a point not included on the boundary, which would. To prove this in general requires a lot of machinery, typically from homology theory, or Sperner's lemma. However, it's actually doable in the case $n \le 2$.
