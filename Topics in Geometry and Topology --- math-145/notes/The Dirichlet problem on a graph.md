...
These graphs with boundary have new "relative" notions of [[Topics in Geometry and Topology --- math-145/notes/Calculus on a graph#_definition _ zeroth Betti number on a graph|Betti number]] and [[Topics in Geometry and Topology --- math-145/notes/Calculus on a graph#_definition _ clopen|clopenness]] that treat the boundary differently.
