...
\begin{solution}
	\begin{enumerate}
		...
		\item
			\begin{lemma}
				Given a polynomial $p \in \mathbb{C}[z]$, there exists a loop $f$ around $z \in \mathbb{C}$ of small enough radius (maximum distance from $z$) such that $w(p \circ f, 0)$ is the multiplicity of the polynomial's root at $z$.
			\end{lemma}
	\end{enumerate}
\end{solution}
