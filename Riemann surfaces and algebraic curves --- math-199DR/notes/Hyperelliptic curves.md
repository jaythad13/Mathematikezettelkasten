...
A hyperelliptic curve is a compact Riemann surface $X$ with a holomorphism $X \to \mathbb{C}_{\infty}$ of [[Riemann surfaces and algebraic curves --- math-199DR/notes/Topological properties of holomorphisms#_definition _ degree of a map|degree]] $2$.
