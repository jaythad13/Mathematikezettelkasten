...
The atlas is [[Riemann surfaces and algebraic curves --- math-199DR/notes/Group actions on Riemann surfaces#$X$ and its quotient|the one inherited]] from $\mathbb{H}$ (pushforward sheaf?).