...
![[Algebraic geometry --- rising-sea/notes/Examples of schemes#_proposition _ the points of the complex affine line]]
...
![[Algebraic geometry --- rising-sea/notes/Examples of schemes#_proposition _ values of functions on $ mathbb{A} 1_{ mathbb{C}}$ are values of polynomials in $ mathbb{C}$|Examples of affine schemes]]

However, they don't always. In particular, functions can take values in different rings,

![[Algebraic geometry --- rising-sea/notes/Examples of schemes#_example _ values of a function on $ operatorname{Spec} mathbb{Z}$ in different fields]]

and are not always determined by their values at points.

![[Algebraic geometry --- rising-sea/notes/Examples of schemes#_example _ functions are not determined by their values|Examples of affine schemes]]
...
![[Algebraic geometry --- rising-sea/notes/Examples of schemes#_example _ $V(xy, yz) subseteq mathbb{A} 3_{ mathbb{C}}$|Examples of affine schemes]]
