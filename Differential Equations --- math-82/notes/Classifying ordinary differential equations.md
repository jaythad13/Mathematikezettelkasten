...
A **linear differential equation** is a differential equation of the form $Dy = f(x, y)$ where $D$ is an $\mathbb{R}$-linear map.
...
A **non-homogenous** (or **driven** or **forced**) linear differential equation is a linear differential equation of the form $Dy = f(x, y)$ for $f$ non-zero.

A **homogenous** linear differential equation is a linear differential equation of the form $Dy = 0$
