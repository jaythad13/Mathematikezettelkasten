...
x_{n + 1} = x_{n} + \Delta x.
$$
Then the **$(n + 1)$th Euler's method iterate with step size $\Delta x$** is given recursively by
$$
...
##### _definition:_ 4th-order Runge–Kutta
...
\end{align}
$$
Then **$(n + 1)$th 4th-order Runge–Kutta iterate with step size $\Delta x$** is given recursively by
$$
