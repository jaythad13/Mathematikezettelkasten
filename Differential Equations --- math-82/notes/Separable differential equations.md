...
Separable differential equations are just one small class of differential equations, even among the small class of differential equations we will learn how to solve. In fact, they are a small subset of even first order ordinary differential equations. However, they are the easiest to solve and are actually fairly common.
