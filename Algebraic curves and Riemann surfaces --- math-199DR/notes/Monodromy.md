...
Given a Riemann surface $X$, and a covering Riemann surface $U$, we want to classify all the holomorphic maps $U \to X$ of given degree $d$ and with branch points only in the give set $B$. We know what unramified maps to ${X \setminus B}$ look like — they are covers. By [[Algebraic curves and Riemann surfaces --- math-199DR/notes/Holomorphisms of Riemann surfaces#_theorem _ identity theorem|identity theorem]] and the [[Algebraic curves and Riemann surfaces --- math-199DR/notes/Topological properties of holomorphisms#_corollary _ ramification points are discrete|discreteness of branch points]] we can classify finite degree maps by classifying conjugacy classes of monodromy representations  $\rho : \pi_{1}(X \setminus B) \to \mathfrak S_{d}$.
