...
All of this means that we have a map of [[Abstract algebra --- math-171/notes/Exact sequences#_example _ short exact sequence|short exact sequences]]!
...
Finally, all of this tells us the most important thing — that elliptic curves are abelian varieties!

##### _corollary:_ elliptic curves are abelian varieties

Every $p_{0} \in X$ induces an isomorphism of Riemann surfaces from $X$ to an abelian variety where $p_{0}$ is the identity.