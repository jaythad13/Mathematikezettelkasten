...
Use [[Mathematical Analysis I --- math-131/notes/Before the real numbers#_definition _ the Peano axioms|the well ordering principle]] to keep picking the $n$th smallest value of $f$, $f(a_{n})$. Then set $f(a_{n}) = n$. By the pigeonhole principle, you never stop.
...
Gloriously, [[Mathematical Analysis I --- math-131/notes/The reals|the reals]] are the first example of an uncountable set.
