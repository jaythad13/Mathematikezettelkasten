...
\begin{solution}
	Denote the triangle by $\Delta$. Suppose by way of contradiction that there was a continuous bijection $f : \Delta \to [0, 1]$. Pick some $a \in (0, 1)$. Since $f$ is a bijection, there is a unique $f^{-1}(a)$.
